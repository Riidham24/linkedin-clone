    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-8">
        <div className="w-full max-w-[400px]">
          <h1 className="text-3xl font-light text-linkedin-text mb-2">Sign in</h1>
          <p className="text-sm text-linkedin-muted mb-6">Stay updated on your professional world</p>
          ...
          <div className="mt-6 text-center text-sm">
            <span className="text-linkedin-muted">New to LinkedIn? </span>
            <Link to="/signup" className="font-semibold text-linkedin-blue hover:underline">
              Join now
            </Link>
          </div>
        </div>
